            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.white,
                  border: Border.all(width: 2, color: Color(0xffb7bec3)),
                  boxShadow: const [
                    BoxShadow(
                      offset: Offset(0, 0),
                      blurRadius: 5,
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(image: AssetImage(manager.imageUrl), fit: BoxFit.cover, scale: 51),
                              ...
                              const Expanded(
                                child: TextField(
                                  decoration: InputDecoration(
                                      ...
                                      enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: Color(0xffe0e1e2), width: 0))),
                                ),
                              ),
                              Container(
