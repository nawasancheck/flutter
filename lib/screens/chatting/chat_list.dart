                                  ...
                                  onTap: () {
                                    ...
                                    Navigator.of(context, rootNavigator: true).push(MaterialPageRoute(
                                        builder: (_) => ChatScreenUser(
                                            '${snapshot.data?.docs[index]['userUID']}', '${snapshot.data?.docs[index]['userName']}', 1)));
                                  },
                                  // 채팅 삭제
                                  onLongPress: () async {
                                    ...
                                    await FirebaseFirestore.instance
                                        ...
                                        .delete();
                                    /*
                                                      .of(context, rootNavigator:true).push(MaterialPageRoute(
                                                        builder:(_)=>ChatScreen('${snapshot.data?.docs[index]['userUID']}',
                                    ...
                                    onTap: () {
                                      ...
                                      Navigator.of(context, rootNavigator: true).push(MaterialPageRoute(
                                          builder: (_) => ChatScreenManager(
                                              '${snapshot.data?.docs[index]['userUID']}', '${snapshot.data?.docs[index]['userName']}', 2)));
                                    },
                                    // 채팅 삭제
                                    onLongPress: () async {
                                      CollectionReference<Map<String, dynamic>> collections = FirebaseFirestore.instance
