          ...
          children: [
                      ...
                      return Padding(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              border: Border.all(color: Colors.blueGrey), color: Color(0xffffffff), borderRadius: BorderRadius.circular(20)),
            ...
            Flexible(
              ...
              child: Container(
                  ...
                  color: Colors.grey,
                  child: StreamBuilder(
                    stream: FirebaseFirestore.instance.collection('board_test').snapshots(),
